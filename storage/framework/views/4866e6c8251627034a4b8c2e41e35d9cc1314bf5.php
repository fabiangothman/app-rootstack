        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                    ...
                    <h1><strong><?php echo e($advertisement->name); ?></strong></h1>                
                    <div class="px-4 py-5 sm:p-6 bg-gray-100 shadow sm:rounded-lg">
                        ...
                        <div class="my-3">
                            ...
                            <div class="my-3">
                                <div class="ml-5 my-2">
                                    <a href="<?php echo e(route('categories.show', $advertisement->category)); ?>"><?php echo e($advertisement->category->name); ?></a>
                                </div>
                            </div>
                        </div>
                        <div class="my-3">
                            ...
                            <div class="my-3">
                                <div class="ml-5 my-2">
                                    <a href="<?php echo e(route('subcategories.show', $advertisement->subcategory)); ?>"><?php echo e($advertisement->subcategory->name); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="my-6">
                        <form action="<?php echo e(route('advertisements.destroy', $advertisement)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php endif; ?> <?php /**PATH C:\xampp\htdocs\app-rootstack\resources\views/advertisements/show.blade.php ENDPATH**/ ?>